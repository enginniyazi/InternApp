...
export declare class InternshipsController {
    ...
    create(userId: string, createInternshipDto: CreateInternshipDto): Promise<{
        company: {
            id: string;
            userId: string;
            companyName: string;
    ...
    findMyInternships(userId: string): Promise<({
        company: {
            id: string;
            userId: string;
            companyName: string;
    ...
    update(userId: string, id: string, updateInternshipDto: UpdateInternshipDto): Promise<{
        company: {
            id: string;
            userId: string;
            companyName: string;
