            ...
            if (companyUser.companyProfile) {
                ...
                if (internshipCount === 0) {
                    const sampleInternships = [
                        ...
                        {
                            title: 'Lise / MYO Donanım & Teknik Destek Stajyeri',
                            description: 'Ofis donanım cihazlarının kurulumu, ağ kablolaması ve temel bilgisayar teknik bakımında görev alacak lise ve MYO öğrencileri.',
